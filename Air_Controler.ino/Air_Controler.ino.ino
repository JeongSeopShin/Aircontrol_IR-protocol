...
const uint16_t rawDataLGOn[RAW_DATA_LEN] PROGMEM ={
...
#define RAW_DATA_LEN 60
const uint16_t rawDataLGOff[RAW_DATA_LEN] PROGMEM ={
...
#define RAW_DATA_LEN 60
const uint16_t rawDataLGDry[RAW_DATA_LEN] PROGMEM ={
...
#define RAW_DATA_LEN 60
const uint16_t rawDataLG23[RAW_DATA_LEN] PROGMEM ={
...
#define RAW_DATA_LEN 60
const uint16_t rawDataLG24[RAW_DATA_LEN] PROGMEM ={
...
#define RAW_DATA_LEN 60
const uint16_t rawDataLG25[RAW_DATA_LEN] PROGMEM ={
...
// Samsung 에어컨 제어 코드
#define RAW_DATA_LEN 234
const uint16_t rawDataSOn[RAW_DATA_LEN] PROGMEM ={
...
#define RAW_DATA_LEN 234
const uint16_t rawDataSOff[RAW_DATA_LEN] PROGMEM ={
  404, 616, 379, 642, 354, 1612, 378, 1612, 
  404, 1586, 404, 1586, 405, 3092, 2879, 9084, 
  380, 1610, 380, 615, 380, 591, 404, 590, 
  405, 590, 405, 591, 404, 592, 403, 642, 
...
#define RAW_DATA_LEN 234
const uint16_t rawDataSDry[RAW_DATA_LEN] PROGMEM ={
  404, 616, 379, 642, 354, 1612, 378, 1612, 
  404, 1586, 404, 1586, 405, 3092, 2879, 9084, 
  380, 1610, 380, 615, 380, 591, 404, 590, 
  405, 590, 405, 591, 404, 592, 403, 642, 
...
#define RAW_DATA_LEN 234
const uint16_t rawDataS23[RAW_DATA_LEN] PROGMEM ={
...
#define RAW_DATA_LEN 130
const uint16_t rawDataS24[RAW_DATA_LEN] PROGMEM ={
  404, 616, 379, 642, 354, 1612, 378, 1612, 
  404, 1586, 404, 1586, 405, 3092, 2879, 9084, 
  380, 1610, 380, 615, 380, 591, 404, 590, 
  405, 590, 405, 591, 404, 592, 403, 642, 
...
#define RAW_DATA_LEN 234
const uint16_t rawDataS25[RAW_DATA_LEN] PROGMEM ={
...
// Carrier 에어컨 제어 코드
#define RAW_DATA_LEN 234
const uint16_t rawDataCOn[RAW_DATA_LEN] PROGMEM ={
...
#define RAW_DATA_LEN 234
const uint16_t rawDataCOff[RAW_DATA_LEN] PROGMEM ={
...
#define RAW_DATA_LEN 234
const uint16_t rawDataCDry[RAW_DATA_LEN] PROGMEM ={
...
#define RAW_DATA_LEN 234
const uint16_t rawDataC23[RAW_DATA_LEN] PROGMEM ={
...
#define RAW_DATA_LEN 234
const uint16_t rawDataC24[RAW_DATA_LEN] PROGMEM ={
...
#define RAW_DATA_LEN 234
const uint16_t rawDataC25[RAW_DATA_LEN] PROGMEM ={
  ...
  if (client) {
    ...
    while (client.connected()) {
     ...
     //   Serial.println(message);
          ...
          // LG 코드
          if ( command == 101 ) {
            mySender.send(rawDataLGOn,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("On"));
          }

          else if ( command == 102 ) {
            mySender.send(rawDataLGOff,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("Off"));
          }

          else if ( command == 103 ) {
            mySender.send(rawDataLGDry,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("Dry"));
          }

          else if ( command == 123 ) {
            mySender.send(rawDataLG23,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("23도_LG"));
          }

          else if ( command == 124 ) {
            mySender.send(rawDataLG24,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("24도_LG"));
          }

          else if ( command == 125 ) {
            mySender.send(rawDataLG25,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("25도_LG"));
          }
         
          // Samsung 코드
          else if ( command == 201 ) {
            mySender.send(rawDataSOn,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("On"));
          }

          else if ( command == 202 ) {
            mySender.send(rawDataSOff,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("Off"));
          }

          else if ( command == 203 ) {
            mySender.send(rawDataSDry,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("Dry"));
          }

          else if ( command == 223 ) {
            mySender.send(rawDataS23,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("23도_S"));
          }

          else if ( command == 224 ) {
            mySender.send(rawDataS24,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("24도_S"));
          }

          else if ( command == 225 ) {
            mySender.send(rawDataS25,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("25도_S"));
          }

          // Carrier 코드
          else if ( command == 301 ) {
            mySender.send(rawDataCOn,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("On"));
          }

          else if ( command == 302 ) {
            mySender.send(rawDataCOff,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("Off"));
          }

          else if ( command == 303 ) {
            mySender.send(rawDataCDry,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("Dry"));
          }

          else if ( command == 323 ) {
            mySender.send(rawDataC23,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("23도_C"));
          }

          else if ( command == 324 ) {
            mySender.send(rawDataC24,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
            Serial.println(F("24도_C"));
          }

          else if ( command == 325 ) {
            mySender.send(rawDataC25,RAW_DATA_LEN,36); //Pass the buffer,length, optionally frequency
